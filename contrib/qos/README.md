...
This means one can have an always-on ulmexd instance running, and another local ulmexd/ulmex-qt instance which connects to this node and receives blocks from it.
