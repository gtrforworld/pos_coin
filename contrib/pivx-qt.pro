...
RESOURCES += src/qt/ulmex.qrc src/qt/ulmex_locale.qrc

TRANSLATIONS += src/qt/locale/ulmex_bg.ts \
                src/qt/locale/ulmex_de.ts \
                src/qt/locale/ulmex_en.ts \
                src/qt/locale/ulmex_es.ts \
                src/qt/locale/ulmex_fi.ts \
                src/qt/locale/ulmex_fr.ts \
                src/qt/locale/ulmex_it.ts \
                src/qt/locale/ulmex_ja.ts \
                src/qt/locale/ulmex_pl.ts \
                src/qt/locale/ulmex_pt.ts \
                src/qt/locale/ulmex_ru.ts \
                src/qt/locale/ulmex_sk.ts \
                src/qt/locale/ulmex_sv.ts \
                src/qt/locale/ulmex_vi.ts \
                src/qt/locale/ulmex_zh_CN.ts \
                src/qt/locale/ulmex_zh_TW.ts
