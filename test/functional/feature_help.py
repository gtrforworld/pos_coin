...
"""Verify that starting ulmex with -h works as expected."""
...
class HelpTest(UlmexTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ulmex with -? for help text")
        ...
        self.log.info("Start ulmex with -version for version information")
