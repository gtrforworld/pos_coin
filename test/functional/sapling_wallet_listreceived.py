...
class ListReceivedTest (UlmexTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 ULME.
        ...
        # Send 1 ULME to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 ULME sending them all (fee is 0.1 ULME)
        ...
        # Confirm transaction (2 ULME from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 ULME, send 0.6 ULME + 0.05 ULME fee
