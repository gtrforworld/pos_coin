...
By default, ulmexd will dump mempool on shutdown and
...
class MempoolPersistTest(UlmexTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ulmexd from writing mempool.dat to disk. Verify that `savemempool` fails")
