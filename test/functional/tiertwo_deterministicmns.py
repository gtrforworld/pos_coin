...
class DIP3Test(UlmexTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 ULME) to the operator, and (2 * 2.7 ULME) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid ULMEX address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid ULMEX address InvalidPayee", controller.protx_update_registrar,
