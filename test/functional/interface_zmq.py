...
from test_framework.test_framework import UlmexTestFramework, SkipTest
...
class ZMQTest (UlmexTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that ulmex has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("ulmexd has not been built with zmq enabled.")
