...
from test_framework.test_framework import UlmexTier2TestFramework
...
class MasternodeGovernanceBasicTest(UlmexTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.ulmex.org/t/test-proposal",
            2,
