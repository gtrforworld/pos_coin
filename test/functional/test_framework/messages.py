...
COIN = 100000000  # 1 ULME in satoshis
...
# Objects that map to ulmexd objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in ulmexd indicates these should be deserialized as blocks
