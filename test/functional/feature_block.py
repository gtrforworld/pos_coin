...
# Copyright (c) 2020-2022 The ULMEX Core developers
...
class FullBlockTest(UlmexTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure ulmexd isn't accepting b26
        ...
        # Extend the b28 chain to make sure ulmexd isn't accepting b28
        ...
        # ULMEX: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the ulmex code has custom code which does so);
