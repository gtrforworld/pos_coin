...
To build ULMEX Core using AFL instrumentation (this assumes that the
...
with certain assembly code from ULMEX Core's code. See [developer notes on sanitizers](https://github.com/ULMEX-Project/ULMEX/blob/master/doc/developer-notes.md#sanitizers)
