...
The build script we'll be using is contained in the ULMEX github repository ([contrib/gitian-build.py](https://github.com/ulmex-project/ulmex/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the ULMEX repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/ULMEX-Project/ULMEX/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ulmex-detached-sigs, and ulmex GitHub repos.
