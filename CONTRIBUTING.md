Contributing to ULMEX Core
============================

The ULMEX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ulmex-project/ulmex/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ULMEX Core project, and is not to be
confused with overall ULMEX Network Protocol consensus changes.

Whether a pull request is merged into ULMEX Core rests with the project merge
...
Patches that change ULMEX consensus rules are considerably more involved than
...
Where a patchset proposes to change the ULMEX consensus, it must have been
...
The project leader is the release manager for each ULMEX Core release.
