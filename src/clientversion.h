...
#error Client version information missing: version is not defined by ulmex-config.h or in any other way
#endif
...
/**
 * ulmexd-res.rc includes this file, but it cannot cope with real c++ code.
