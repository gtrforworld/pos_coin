...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("ulmex"), "Ulmex");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://ulmex.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/ulmex"));
    BOOST_CHECK(validateURL("https://foo.bar/ulmex/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.ulmex.com"));
