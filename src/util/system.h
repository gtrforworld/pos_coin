...
extern const char * const ULMEX_CONF_FILENAME;
extern const char * const ULMEX_PID_FILENAME;
extern const char * const ULMEX_MASTERNODE_CONF_FILENAME;
