...
static MapCheckpoints mapCheckpoints = {
    ...
    {2365700, uint256S("b5d0beead57735539abc2db2b0b08cd65db3e5928efd3c3bf3182d5bf013f36c")}, //!< ULMEX v4.1.1 enforced
    {2678402, uint256S("580a26ff0a45177a7a6f387f009c5b26140ea48b4790a857d9a796f8b3c25899")}, //!< Network split here
    {3014000, uint256S("78ad99b7225f73c42238bd7ca841ff700542b92bba75a0ef2ed351caa560f87f")}, //!< ULMEX v5.3.0 enforced
...
public:
    CMainParams()
    {
        ...
        // validation by-pass
        consensus.nUlmexBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nUlmexBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.emplace_back("ulmex.seed.fuzzbawls.pw", true);     // Primary DNS Seeder from Fuzzbawls
        vSeeds.emplace_back("ulmex.seed2.fuzzbawls.pw", true);    // Secondary DNS Seeder from Fuzzbawls
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "ulmeks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("ulmex-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("ulmex-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ulmex addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ulmex script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[EXCHANGE_ADDRESS] = {0x01, 0xb9, 0xb1};   // EXT prefix for the address
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ulmex BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet ulmex BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet ulmex BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "ulmektestsapling";
