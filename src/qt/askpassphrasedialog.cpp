...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ULMEXGUI* window = static_cast<ULMEXGUI*>(parentWidget());
...
{
    ULMEXGUI* gui = static_cast<ULMEXGUI*>(parentWidget());
...
{
    hide();
    static_cast<ULMEXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Your wallet is now encrypted. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ULMEs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
