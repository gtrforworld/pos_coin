...
#include "qt/ulmex/createproposaldialog.h"
#include "qt/ulmex/forms/ui_createproposaldialog.h"
...
CreateProposalDialog::CreateProposalDialog(ULMEXGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.ulmex/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 ULME");
