...
#include "qt/ulmex/forms/ui_masternodeswidget.h"

#include "qt/ulmex/qtutils.h"
#include "qt/ulmex/mnrow.h"
#include "qt/ulmex/mninfodialog.h"
#include "qt/ulmex/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(ULMEXGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::ULME)));
        return;
    }
