...
#ifndef ULMEX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define ULMEX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //ULMEX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
