...
#ifndef ULMEX_CORE_NEW_GUI_ULMEXGUI_H
#define ULMEX_CORE_NEW_GUI_ULMEXGUI_H
...
#include "qt/ulmex/navmenuwidget.h"
#include "qt/ulmex/topbar.h"
#include "qt/ulmex/dashboardwidget.h"
#include "qt/ulmex/send.h"
#include "qt/ulmex/receivewidget.h"
#include "qt/ulmex/addresseswidget.h"
#include "qt/ulmex/coldstakingwidget.h"
#include "qt/ulmex/governancewidget.h"
#include "qt/ulmex/masternodeswidget.h"
#include "qt/ulmex/snackbar.h"
#include "qt/ulmex/settings/settingswidget.h"
...
/**
  ULMEX GUI main class. This class represents the main window of the ULMEX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ULMEXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ULMEXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ULMEXGUI();
...
#endif //ULMEX_CORE_NEW_GUI_ULMEXGUI_H
