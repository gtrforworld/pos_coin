...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ULMEXGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, ULMEXGUI* gui, double posX = 3);
