...
#include "qt/ulmex/forms/ui_coldstakingwidget.h"
#include "qt/ulmex/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/ulmex/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(ULMEXGUI* parent) :
    PWidget(parent),
