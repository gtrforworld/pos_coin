...
#include "qt/ulmex/settings/settingsnetworkwidget.h"
#include "qt/ulmex/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ulmex/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ULMEXGUI* _window, QWidget *parent) :
