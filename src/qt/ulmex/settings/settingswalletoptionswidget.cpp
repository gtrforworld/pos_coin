...
#include "qt/ulmex/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ulmex/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ULMEXGUI* _window, QWidget *parent) :
