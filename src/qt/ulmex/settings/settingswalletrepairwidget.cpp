// Copyright (c) 2019-2020 The ULMEX Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/ulmex/settings/settingswalletrepairwidget.h"
#include "qt/ulmex/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ulmex/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ULMEXGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ULMEXGUI::handleRestart()
