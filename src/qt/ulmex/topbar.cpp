...
#include "qt/ulmex/topbar.h"
#include "qt/ulmex/forms/ui_topbar.h"
#include "qt/ulmex/lockunlock.h"
#include "qt/ulmex/qtutils.h"
#include "qt/ulmex/receivedialog.h"
#include "qt/ulmex/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/ulmex/balancebubble.h"
...
TopBar::TopBar(ULMEXGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopUlme, ui->labelAmountTopShieldedUlme}, "amount-small-topbar");
    setCssProperty({ui->labelAmountUlme}, "amount-topbar");
    setCssProperty({ui->labelPendingUlme, ui->labelImmatureUlme}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("ULMEX")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // ULME Total
    QString totalUlme = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // ULME
    // Top
    ui->labelAmountTopUlme->setText(totalTransparent);
    ui->labelAmountTopShieldedUlme->setText(totalShielded);
    // Expanded
    ui->labelAmountUlme->setText(totalUlme);
    ui->labelPendingUlme->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureUlme->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
