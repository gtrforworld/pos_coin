...
#include "qt/ulmex/sendcustomfeedialog.h"
#include "qt/ulmex/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ULMEXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ULMEXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
