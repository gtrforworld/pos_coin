...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ULME);
    unitlist.append(mULME);
    unitlist.append(uULME);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case ULME:
        return QString("ulmex");
    case mULME:
        return QString("mulmex");
    case uULME:
        return QString::fromUtf8("uulmex");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZulme)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZULME)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZULME);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZULME)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZULME));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
