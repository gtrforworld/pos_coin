...
/** Utility functions used by the ULMEX Qt UI.
 */
namespace GUIUtil
{
...
// Render ULMEX addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZulme = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZulme = false);
...
// Parse "ulmex:" URI into recipient object, return true on successful parsing
