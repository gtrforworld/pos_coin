...
// Copyright (c) 2015-2020 The ULMEX Core developers
...
/* Ulmex GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ULMEX"
#define QAPP_ORG_DOMAIN "ulmex.org"
#define QAPP_APP_NAME_DEFAULT "ULMEX-Qt"
#define QAPP_APP_NAME_TESTNET "ULMEX-Qt-testnet"
